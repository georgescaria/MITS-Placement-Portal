...
if ( $_SESSION['admin_logged_in'] != 1 ) {
  ...
  header("location: error.php");    
    ...
    $test_details = ($mysqli->query("SELECT distinct(test_id),test_title,test_date from test"));
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-check'></i> Tests</h1>
            		            	</div>
            	<!-- Page Heading End-->	
				 ...
				 <div class="row">
                    <div class="col-sm-12 portlets">
                        <div class="list-group">
                          ...
                          <a href="test_results.php?test_id=<?=$test_id?>" class="list-group-item list-group-item-action flex-column align-items-start ">
                            <div class="d-flex w-100 justify-content-between">
                              <h4 class="mb-1"><b><?= $test_title?></b></h4>
