...
if ( $_SESSION['admin_logged_in'] != 1 ) {
  ...
  header("location: error.php");
    ...
    $branch = $_SESSION['branch'];
  	...
  	$drive_details = ($mysqli->query("SELECT distinct company_name from new_drive"));
				 ...
				 <div class="row">
                    <div class="col-sm-12 portlets">
                        <div class="list-group">
                          ...
                          <a href="placementdrive_applied.php?company=<?=$company_name?>" class="list-group-item list-group-item-action flex-column align-items-start ">
