...
<?php
 ...
 while($row = mysqli_fetch_array($result)) { ?>
    ...
    <td> <a  style="color:#15b3db;" href="viewProfile.php?college_id=<?=$row['college_id']?>"><?php echo $row['college_id'] ?> </a></td>
...
<div class="dropdown">
<form >
<button name="export" id="export" type="submit" class="dropbtn" onclick="exportTableToExcel('keywords')"  >Export</button>
</form>
</div>
...
function exportTableToExcel(tableID, filename = ''){
    ...
    // Specify file name
    filename = filename?filename+'.xls':'Placed.xls';
