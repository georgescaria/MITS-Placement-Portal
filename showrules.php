...
<?php require 'student_left.php'; ?>
        ...
        <div class="content-page">
            ...
            <div class="content">
            	...
            	<!-- Page Heading End-->	
				 ...
				 <div class="row">
                    ...
                    <?php
                            $minutes = floor((($time_limit % 86400) % 3600) / 60);
                            $hours = floor(($time_limit % 86400) / 3600);
                    ?>

                        <h3 >Time Limit </h3><h4><?= $hours?> Hours  <?= $minutes?> Minutes</h4>
                        <br><br>

                        <h3 >Rules</h3>
                        <h4><?= $rules?></h4><br><br>
                    <form method="POST">
                               <button style="display: block; margin: 0 auto;" name="start" type="submit" class="btn btn-primary" >Start test</button>
                    </form>
            ...
            ?>
                        ...
                        window.location = "start_test.php";
                        </script>
            <?php            
                        }
            ?>
