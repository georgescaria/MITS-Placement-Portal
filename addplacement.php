...
if ( $_SESSION['admin_logged_in'] != 1 ) {
  ...
  header("location: error.php");    
    ...
    $branches = $mysqli->query("SELECT distinct branch from users");
       ...
       <div class="content-page">   
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class='fa fa-check'></i> Add placement</h1>
                                    </div>
                <!-- Page Heading End-->    
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-content padding">
                                <ul id="demo1" class="nav nav-tabs">
                                    ...
                                    <li class="active">
                                        <a href="#individual" data-toggle="tab"> Details </a>
                                    </li> 

                                    <li class="">
                                        <a href="#excel-import" data-toggle="tab"> Import File </a>
                                    </li> 
                                        ...
                                        <div class="widget">
                                            ...
                                            <form class="form-horizontal" role="form" method="POST">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                   <select class="form-control"  name="branch"  onchange="showUser(this.value)">
                                                    <?php 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                  <input type="text" class="form-control" id="input-text" name="college_id" placeholder="Enter college ID">
                                                </div>
                                              </div>   


                                            <div class="form-group">
                                                <label for="input-text" class="col-sm-2 control-label">Student Name</label>
                                                <div class="col-sm-10">
                                                  <input type="text" class="form-control" id="input-text" name="student_name" placeholder="Enter student name">
                                                </div>
                                              </div>   
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                  <input type="text" class="form-control" id="input-text" name="company_name" placeholder="Enter company name">
                                                </div>
                                              </div>   
                                               ...
                                               <form action="" method="post"
                                                        ...
                                                        <div>
                                                            <label>Choose File:</label> <input type="file" name="file"
                                                                ...
                                                                <a href="uploads/Import placement format.xls" target="_BLANK">Download</a> sample format
                           ...
                           <?php
                                       ...
                                       if (isset($_POST['add'])) 
                                            { 
                                                    ...
                                                    $insertn = ($mysqli->query("INSERT INTO placed (college_id,student_name,company,package,batch,branch) values ('$college_id','$student_name','$company_name','$package','$batch','$branch')"));
                                          ...
                                          if(in_array($_FILES["file"]["type"],$allowedFileType))
                                          {
                                                ...
                                                for($i=0;$i<$sheetCount;$i++)
                                                {
                                                    ...
                                                    foreach ($Reader as $Row)
                                                    {
                                                        ...
                                                        $import_company = "";
                                                        if(isset($Row[2])) {
                                                            $import_company = mysqli_real_escape_string($mysqli,$Row[2]);
                                                        }
                                                       
                                                        $import_package = "";
                                                        if(isset($Row[3])) {
                                                            $import_package = mysqli_real_escape_string($mysqli,$Row[3]);
                                                        }

                                                         $import_batch = "";
                                                        if(isset($Row[4])) {
                                                            $import_batch = mysqli_real_escape_string($mysqli,$Row[4]);
                                                        }

                                                        $import_branch = "";
                                                        if(isset($Row[5])) {
                                                            $import_branch = mysqli_real_escape_string($mysqli,$Row[5]);
                                                        }
                                                        

                                                        
                                                        
                                                        if (!empty($import_college_id) || !empty($import_name) || !empty($import_branch)|| !empty($import_batch) || !empty($import_package) || !empty($import_company)) {
                                                            $query = "insert into placed values('".$import_college_id."','".$import_name."','".$import_company."','".$import_package."','".$import_batch."','".$import_branch."')";
